			...
			public void actionPerformed(ActionEvent e) {
				...
				if(getselectedafterplacesearch  )
					...
					if(getselecctedafterdirectionsearch==true)
					{
						...
						dis_dij=aa.shortest_dist(nodes, parent, src, dest);
						System.out.println("star distance returned="+dis_dij);
...
//			System.out.println("here before astar");
//			//caculation of straight line distace for astar algo...
//			double st_line_dist=0; 
//			for(int i=0;i<1;i++) {
//				 for (int j = i+1; j < nodes.size(); j++) {
//					 st_line_dist=d.calculateDistance(nodes.elementAt(i).lat, nodes.elementAt(i).lon, nodes.elementAt(j).lat, nodes.elementAt(j).lon);
//					 nodes.elementAt(i).straight_line_dist.addElement(st_line_dist);
//					 nodes.elementAt(j).straight_line_dist.addElement(st_line_dist);
//					 System.out.println("st dist="+st_line_dist);
//						
//				}
//			 }
			///////////////////////////////////////////////////
